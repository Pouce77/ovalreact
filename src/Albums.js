...
import imgAlbum3 from './images/album3.jpg';
...
const Albums = () => {
  return (
    ...
    <div className='divImage widthImage'>
      ...
      <div className='description'>
        <p> <small> "Le deuxième album d'Oval Skylight"</small></p>
      </div>
    </div>
    <div className='album flexDir scale-up-center'>
    <div className='divImage widthImage'>
      <a href="https://open.spotify.com/intl-fr/album/1Fi5TpsLLCbG6SOxEUL5aE?fbclid=IwY2xjawKVLWFleHRuA2FlbQIxMAABHox5G3YRewmbQxydbn4fa5GS8RrKt046LZsiym1H31RrSYQLBn5SzLzqNXqS_aem_Q96gW2838l7WfoGq8M7GoA" className="m-4" target="_blank" rel="noreferrer">
        <img className='image' src={imgAlbum3} alt="album n°2"></img>
      </a>
      </div>
      <div className='divTitle'>
        <h2>Opus 3</h2>
      ...
      <div className='description'>
        <p> <small> "Découvrez le nouvel album d'Oval Skylight!"</small></p>
      </div>
    </div>
    </>
  )
